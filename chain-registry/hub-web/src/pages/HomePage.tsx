  ...
  return (
    <div className="hub-page">
      ...
      <section className="hub-note">
        ...
        not mainnet and not a production security guarantee. External audit,
        validator expansion, IPFS availability, and public-alpha rehearsals
        remain part of the readiness path.
      </section>
